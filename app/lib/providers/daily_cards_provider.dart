...
final dailyCardsProviderFamily = FutureProviderFamily<List<DailyCardObj>, DateTime>((ref, date) async {
  ...
  return await ref.read(dailyCardRepositoryProvider).readDailyCardsByDate(userId, date);
});